$(document).ready(function() {
    ...
    $('.skills-rating').waypoint(function(direction){
        if (!pbAlreadyLoaded) {
            ...
            progressBar('.inner-meter.bootstrap', 70);
            progressBar('.inner-meter.js-jquery', 55);
            progressBar('.inner-meter.angular', 60);
            progressBar('.inner-meter.php-mysql', 70);
            progressBar('.inner-meter.laravel', 50);
